...
function replaceIt() {
    ...
    var theStory = "<h1>Sithembiso's Dance Party</h1>";
    theStory += "One " + adj1 + " day, Sithembiso was " + verbIng + " in his " + roomInHouse + ", reading a book about " + color + " " + nounPlural + ".<br><br>";
    theStory += "As he " + pastVerb + " his " + beverage + ", he heard " + musicType + " music playing in the " + diffRoom + ".<br><br>";
    theStory += exclamation + "! he exclaimed, as he " + pastVerb2 + " down the stairs to join the " + verb + " He quickly searched for his shoes " + adjDance + " party.<br><br>";
    theStory += "Sithembiso danced the " + animal + " Dance, the " + city + " Shake, and took the prize for dancing the best Electric " + noun + "<br><br>";
    theStory += "They live " + adverb + " in a beautiful house.<br><br>";
